...
public class spoolShooter extends ParallelCommandGroup {
  /** Creates a new zeroIntakeShooter. */
  intakeSubsystem sIntake;
  shooterSubsytem sShooter;
  setIntake cSetIntake;
  public spoolShooter(intakeSubsystem sIntake, shooterSubsytem sShooter) {
    ...
    addCommands(new setIntake(sIntake, Constants.subsystemConstants.kIntakeZero, false,false), 
