...
public class zeroIntakeShooter extends ParallelCommandGroup {
  /** Creates a new zeroIntakeShooter. */
  intakeSubsystem sIntake;
  shooterSubsytem sShooter;
  setIntake cSetIntake;
  public zeroIntakeShooter(intakeSubsystem sIntake, shooterSubsytem sShooter) {
    ...
    addCommands(new setIntake(sIntake, 0, false,false), 
